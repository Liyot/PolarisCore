...
use Polaris\forms\element\BaseElement;
...
class CustomForm extends BaseForm{
	...
	public function __construct(
		...
		Utils::validateCallableSignature( function(PolarisPlayer $player, CustomFormResponse $response){ }, $onSubmit);
		if($onClose !== null){
			/** @phpstan-ignore-next-line */
			Utils::validateCallableSignature( function(PolarisPlayer $player){ }, $onClose);
		}
