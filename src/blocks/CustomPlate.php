...
//TODO: Error at the start of the server maybe due to this class

class CustomPlate extends PressurePlate{

    protected bool $pressed = false;

    public function __construct(){
        $weightedPressurePlateBreakInfo = new BreakInfo(0.5, ToolType::PICKAXE, ToolTier::WOOD()->getHarvestLevel());
        parent::__construct(new BlockIdentifier(BlockLegacyIds::HEAVY_WEIGHTED_PRESSURE_PLATE, 0),
            "Weighted Pressure Plate Heavy", $weightedPressurePlateBreakInfo );
    }
